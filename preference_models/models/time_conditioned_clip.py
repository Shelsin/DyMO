...
class TimestepEmbedder(nn.Module):
    ...
    def forward(self, t, inference_type):
        t_freq = self.timestep_embedding(t, self.frequency_embedding_size)
        t_freq = t_freq.to(inference_type)
...
class HFTimeConditionedCLIPModel(CLIPModel):
    def __init__(self, config: CLIPConfig):
        ...
        # self.t_embedder.mlp[0].weight = self.t_embedder.mlp[0].weight.to(inference_dtype)
        # self.t_embedder.mlp[2].weight = self.t_embedder.mlp[2].weight.to(inference_dtype)
    ...
    def get_image_features(
        ...
        time_cond = self.t_embedder(time_cond, pixel_values.dtype)
